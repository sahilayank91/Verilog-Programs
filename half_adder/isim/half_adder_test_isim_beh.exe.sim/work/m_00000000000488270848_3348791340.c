...
#endif
static const char *ng0 = "a = %d, b = %d, s = %d, c = %d\n";
static const char *ng1 = "E:/Verilog programs/half_adder/half_adder_test.v";
static int ng2[] = {0, 0};
static int ng3[] = {1, 0};
...
{
	static char *pe[] = {(void *)Initial_43_0,(void *)Initial_59_1,(void *)Monitor_61_2};
